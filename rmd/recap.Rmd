...
```
<p class="check-no">&#10060; Mehrere Werte pro Zelle</p>
]
...
```
<p class="check-no">&#10060; Datumswerte als Spaltennamen</p>
]
...
```
<p class="check-yes">&#10003; Eine Variable pro Spalte, ein Wert pro Zelle</p>
]
]
